...
class ObjectTypeBasicTestCase(unittest.TestCase):
    ...
    def testObjectTypeDescription(self):
        self.assertEqual(self.ctx["testObjectType"].getDescription(), "Test object", "bad DESCRIPTION")
    ...
    def testObjectTypeSyntax(self):
        self.assertEqual(self.ctx["testObjectType"].getSyntax().clone(123), 123, "bad SYNTAX")

    def testObjectTypeClass(self):
        self.assertEqual(self.ctx["testObjectType"].__class__.__name__, "MibScalar", "bad SYNTAX")
...
class ObjectTypeStringDefaultTestCase(unittest.TestCase):
    ...
    def testObjectTypeSyntax(self):
        self.assertEqual(self.ctx["testObjectType"].getSyntax(), b"test value", "bad DEFVAL")
...
class ObjectTypeWithIntegerSetConstraintTestCase(unittest.TestCase):
    ...
    def testObjectTypeSyntax(self):
        self.assertEqual(
            self.ctx["testObjectType"].getSyntax().clone(44), 44, "bad multiple integer constrained SYNTAX"
        )
...
class ObjectTypeWithStringSizeConstraintTestCase(unittest.TestCase):
    ...
    def testObjectTypeSyntax(self):
        self.assertEqual(self.ctx["testObjectType"].getSyntax().clone(""), b"", "bad size constrained SYNTAX")
...
class ObjectTypeBitsTestCase(unittest.TestCase):
    ...
    def testObjectTypeSyntax(self):
        self.assertEqual(self.ctx["testObjectType"].getSyntax().clone(("set",)), b"@", "bad BITS SYNTAX")
...
class ObjectTypeMibTableTestCase(unittest.TestCase):
    ...
    def testObjectTypeTableClass(self):
        self.assertEqual(self.ctx["testTable"].__class__.__name__, "MibTable", "bad table class")

    def testObjectTypeTableRowClass(self):
        self.assertEqual(self.ctx["testEntry"].__class__.__name__, "MibTableRow", "bad table row class")

    def testObjectTypeTableColumnClass(self):
        self.assertEqual(self.ctx["testIndex"].__class__.__name__, "MibTableColumn", "bad table column class")

    def testObjectTypeTableRowIndex(self):
        self.assertEqual(self.ctx["testEntry"].getIndexNames(), ((0, "TEST-MIB", "testIndex"),), "bad table index")
...
class ObjectTypeMibTableImpliedIndexTestCase(unittest.TestCase):
    ...
    def testObjectTypeTableRowIndex(self):
        self.assertEqual(
            self.ctx["testEntry"].getIndexNames(), ((1, "TEST-MIB", "testIndex"),), "bad IMPLIED table index"
        )
