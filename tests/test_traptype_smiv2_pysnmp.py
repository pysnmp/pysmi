...
class TrapTypeTestCase(unittest.TestCase):
    ...
    def testTrapTypeDescription(self):
        self.assertEqual(self.ctx["testTrap"].getDescription(), "Test trap", "bad DESCRIPTION")

    def testTrapTypeClass(self):
        self.assertEqual(self.ctx["testTrap"].__class__.__name__, "NotificationType", "bad SYNTAX class")
