...
class ObjectGroupTestCase(unittest.TestCase):
    ...
    def testObjectGroupDescription(self):
        self.assertEqual(
            self.ctx["testObjectGroup"].getDescription(), "A collection of test objects.", "bad DESCRIPTION"
        )
    ...
    def testObjectGroupClass(self):
        self.assertEqual(self.ctx["testObjectGroup"].__class__.__name__, "ObjectGroup", "bad SYNTAX class")
