...
class ModuleComplianceTestCase(unittest.TestCase):
    ...
    def testModuleComplianceDescription(self):
        self.assertEqual(
            self.ctx["testCompliance"].getDescription(), "This is the MIB compliance statement", "bad DESCRIPTION"
        )

    def testModuleComplianceClass(self):
        self.assertEqual(self.ctx["testCompliance"].__class__.__name__, "ModuleCompliance", "bad SYNTAX class")
