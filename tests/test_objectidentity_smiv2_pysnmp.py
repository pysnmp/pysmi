...
class ObjectIdentityTestCase(unittest.TestCase):
    ...
    def testObjectIdentityDescription(self):
        self.assertEqual(self.ctx["testObject"].getDescription(), "Initial version", "bad DESCRIPTION")
    ...
    def testObjectIdentityClass(self):
        self.assertEqual(self.ctx["testObject"].__class__.__name__, "ObjectIdentity", "bad SYNTAX class")
