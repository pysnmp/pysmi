...
pysmi carries 485 MIB modules of its own, in ``pysmi/mibs/asn1/``. They are
...
maintenance, freshness and shipping applies to the 485 below and not to
them.
...
12 modules carry a patch, listed under :ref:`bundled-mib-patches` below,
